const translations = {
    en: {
        ...
        "contact-error-generic": "An error occurred while sending.",
    ...
    fr: {
        ...
        "contact-error-generic": "Une erreur est survenue lors de l'envoi.",
        "contact-error-network": "Erreur de connexion. Veuillez réessayer.",
